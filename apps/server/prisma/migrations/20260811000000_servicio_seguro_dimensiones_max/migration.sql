...
ALTER TABLE servicios
  ADD COLUMN IF NOT EXISTS minimo_seguro_postalservicios numeric(18,2),
  ADD COLUMN IF NOT EXISTS alto_max_cmservicios          numeric(8,1),
  ADD COLUMN IF NOT EXISTS ancho_max_cmservicios         numeric(8,1),
  ADD COLUMN IF NOT EXISTS largo_max_cmservicios         numeric(8,1);
